    ...
    return (
        <div class="flex justify-center items-center">
            <div class="container">
                ...
                <img className="h-40 w-40" src="/Notepad.jpg"></img>
                <h3>What if I get stuck?</h3>
                <p>Everyone does! If you see a mystery bird, note down as many details as you can including its appearance, song, location and behaviour. If you can take a photo (even if it’s not a good one) that will help. Use the information to consult a field guide, share with a local bird group or social media. Don’t be afraid to ask questions.</p>

                <img className="h-40 w-40" src="/Hide.jpg"></img>
