function RecordThis() {
    return (
        ...
        <div class="container">
            ...
            <p class="font-large mb-1">Birding is a great way to see wildlife, but how do you get started?</p>
            ...
            <h3 class="mt-5">Where do I start birdwatching?</h3>
            <p class="mt-2">Start wherever you are! Birds are everywhere if you take the time to notice them. Begin by trying gardens, parks, local reserves or woods. Find a spot you know well, ideally somewhere birds are easy to see – with feeders, perhaps. This is where you can get your eye in and become familiar with a good selection of species.</p>
